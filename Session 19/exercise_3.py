...
ENDPOINT = "/users/"
GITHUB_ID = input("Introduce the user you want to know the information:")
METHOD = "GET"
...
#This is to know the name of the repositories
conn = http.client.HTTPSConnection(HOSTNAME)
...
text_json = r1.read().decode("utf-8")
conn.close()
repos_list = json.loads(text_json)
for repo in repos_list:
    print("The name of the repos is:{}".format(repo['name']))
...
conn.close()
repos_list = json.loads(text_json)
print("Total commits:", len(repos_list))
